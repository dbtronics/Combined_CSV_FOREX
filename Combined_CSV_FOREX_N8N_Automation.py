...
# Capture CLI arguments instead of using input()
acct_id = sys.argv[1]  # '7194'
start_year = int(sys.argv[2])  # 2025
end_year = int(sys.argv[3])  # 2025
start_month = int(sys.argv[4])  # 3
end_month = int(sys.argv[5])  # 3
start_day = int(sys.argv[6])  # 1
end_day = int(sys.argv[7])  # 7
period_string = sys.argv[8]  # 'Weekly'
time_frequency = sys.argv[9]  # '2h'
